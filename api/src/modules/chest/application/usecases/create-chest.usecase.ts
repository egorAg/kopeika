...
import { CreateChestDto } from '../../interfaces/dtos/create-chest.dto';
...
export class CreateChestUseCase {
  ...
  async execute(guildId: string, userId: string, dto: CreateChestDto) {
    ...
    return this.chests.create({ ...dto, guild });
  }
}
